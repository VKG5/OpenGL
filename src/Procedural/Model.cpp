    ...
    for(size_t i = 0; i < scene->mNumMaterials; i++) {
        ...
        if(material->GetTextureCount(aiTextureType_DIFFUSE)) {
            ...
            if(material->GetTexture(aiTextureType_DIFFUSE, 0, &path) == AI_SUCCESS) {
                ...
                std::string texPath = std::string("D:/Programs/C++/Yumi/src/Procedural/Textures/") + fileName;
        ...
        if(!textureList[i]) {
            // textureList[i] = new Texture("D:/Programs/C++/Yumi/src/Procedural/Textures/brickHi.png");
            // textureList[i]->loadTextureA();
            textureList[i] = new Texture("D:/Programs/C++/Yumi/src/Procedural/Textures/white.jpg");
